...
public class CkAdapter extends CommonAdapter {

    private ViewHolder holder;
    private LayoutInflater inflater;

    public CkAdapter(Context mContext, List<Map<String, Object>> mDataList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.mCkName.setText(StringUtil.convertStr(data.get("JGZ_JGMC")));
