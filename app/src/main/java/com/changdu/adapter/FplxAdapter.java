...
public class FplxAdapter extends CommonAdapter {

    private ViewHolder holder;
    private LayoutInflater inflater;

    public FplxAdapter(Context mContext, List<Map<String, Object>> mDataList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.mCkName.setText(StringUtil.convertStr(data.get("IV_MC")));
