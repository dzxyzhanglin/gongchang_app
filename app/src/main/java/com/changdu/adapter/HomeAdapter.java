...
public class HomeAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(com.changdu.R.layout.item_home, parent, false);
            holder.icon = convertView.findViewById(R.id.home_icon);
            holder.text = convertView.findViewById(R.id.home_text);
