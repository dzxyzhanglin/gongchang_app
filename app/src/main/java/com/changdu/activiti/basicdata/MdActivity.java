...
public class MdActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        // 设置标题
        setTitle(getString(R.string.title_md), true);

        mListView = findViewById(R.id.lv_ck);

        Intent intent = getIntent();
        SBID = intent.getStringExtra("SBID");
    ...
    private void initData() {
        ...
        RequestCenter.GETMDItems(properties, new WebServiceUtils.WebServiceCallBack() {
                ...
                if ("True".equals(Sucecss)) {
                    ...
                    mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                            ...
                            String NAME = StringUtil.convertStr(data.get("SPK_SPMC"));

                            Intent intent = new Intent();
                            intent.putExtra("ID", ID);
                            intent.putExtra("NAME", NAME);
                            setResult(Constant.ACTIVITI_FOR_RESULT_MD, intent);
                            finish();
                        }
                    });
                } else {
